...
class EnvBatch(object):
    ...
    def __init__(self, connectivity_dir,feature_store=None,scan_data_dir=None, feat_db=None, batch_size=100):
        """
...
class R2RBatch(object):
    ...
    def __init__(
        ...
        seed=0, name=None, sel_data_idxs=None,feat_db=None
    ):
        ...
        # nx.draw(self.graphs['17DRP5sb8fy'],with_labels=True)
        # with open("path.txt",'w') as f:
        #     for i in self.graphs['17DRP5sb8fy'].edges:
        #         f.write("%s %s \n"%(i[0],i[1]))
        # print(len(self.graphs["17DRP5sb8fy"].edges))
    ...
    def _get_obs(self, env,t=None, shortest_teacher=False):
        obs = []
    ...
    def reset(self, env,**kwargs):
        ...
        # print(viewpointIds)
        # print(headings)
        return self._get_obs(env,t=0)

    def step(self, actions, env,t=None):
        ''' Take action (same interface as makeActions) '''
        env.makeActions(actions)
        return self._get_obs(env,t=t)

...
def build_dataset(args, rank=0, is_test=False):
    ...
    feat_db_train = ImageFeaturesDB(args.img_ft_file, args.image_feat_size, args.img_aug_ft_file)#,args.img_aug_ft_file1,args.img_aug_ft_file2
    ...
    train_instr_data = construct_instrs(
        args.anno_dir, args.dataset, [temp], tokenizer=tok, max_instr_len=args.max_instr_len
    )
    ...
    for split in val_env_names:
        ...
        val_env = dataset_class(
            feat_db_val, val_instr_data, args.connectivity_dir, batch_size=24,
            angle_feat_size=args.angle_feat_size, seed=args.seed+rank,
...
def train(args, train_env, val_envs, aug_env=None, rank=-1):
    ...
    if args.dataset == 'r4r':
        best_val = {'val_unseen_sampled': {"spl": 44.05, "sr": 49.80, "state":""}}
    else:

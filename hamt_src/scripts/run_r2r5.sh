...
CUDA_VISIBLE_DEVICES='0' python r2r/main.py $flag  \
      ...
      --features_aug1 vit-16-spade-mask-original-768-e2e \
      --features_aug2 vit-16-spade-original-768-e2e
#--eval_first
...
# CUDA_VISIBLE_DEVICES='0' python r2r/main.py $flag \
#      --resume_file ../datasets/R2R/exprs/finetune/six_train/best_val_unseen  \
#      --test --submit

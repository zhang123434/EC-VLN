...
def parse_args():
    ...
    parser.add_argument("--features_aug1", default=None)
    parser.add_argument("--features_aug2", default=None)
...
def postprocess_args(args):
    ...
    if args.features_aug1:
        args.img_aug_ft_file1=os.path.join(ROOTDIR, 'R2R', 'features',ft_file_map[args.features_aug1] )
    else:
        args.img_aug_ft_file1 = None
    if args.features_aug2:
        args.img_aug_ft_file2=os.path.join(ROOTDIR, 'R2R', 'features',ft_file_map[args.features_aug2] )
    else:
        args.img_aug_ft_file2 = None
    ...
    # Build paths
    args.ckpt_dir = os.path.join(args.output_dir, 'ckpts1')
    args.log_dir = os.path.join(args.output_dir, 'logs1')

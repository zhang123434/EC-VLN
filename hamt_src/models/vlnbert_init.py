...
def get_tokenizer(args):
    ...
    if args.dataset == 'rxr' or args.tokenizer == 'xlm':
        ...
        # print("load ",cfg_name)
        tokenizer = AutoTokenizer.from_pretrained("/root/mount/Matterport3DSimulator/EnvEdit-main/rxr_tokenizer/")
    else:
...
def get_vlnbert_models(args, config=None):
    ...
    if args.dataset == 'rxr' or args.tokenizer == 'xlm':
        cfg_name = 'xlm-roberta-base'
        # print("load ",cfg_name)
        vis_config = PretrainedConfig.from_pretrained("/root/mount/Matterport3DSimulator/EnvEdit-main/rxr_config/")
    else:
        cfg_name = 'bert-base-uncased'

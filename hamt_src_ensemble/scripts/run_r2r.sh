...
#       --bert_ckpt_file ../expr/reduce_task/model_step_250000.pt \
#       --features_aug vit-16-st-samefilter-768-e2e
#--eval_first
#../datasets/R2R/trained_models/vitbase-6tasks-pretrain-e2e/model_step_22000.pt
#../datasets/R2R/exprs/pretrain/cmt-vitbase-6tasks/ckpts/model_step_185000.pt
#../datasets/R2R/trained_models/vitbase-6tasks-pretrain/model_step_130000.pt
#../datasets/R2R/exprs/pretrain/cmt-vitbase-6tasks/first/model_step_195000.pt
# inference
...
CUDA_VISIBLE_DEVICES='0' python r2r/test.py $flag \
     --resume_file  ../datasets/R2R/exprs/finetune/best_train/best_val_unseen \
     --resume_file1  ../datasets/R2R/exprs/finetune/second_augmentation/best_val_unseen \
     --test --submit
     
# 
# ../datasets/R2R/exprs/finetune/third_train/best_val_unseen
# CUDA_VISIBLE_DEVICES='0' python r2r/test.py $flag \
#      --test --submit